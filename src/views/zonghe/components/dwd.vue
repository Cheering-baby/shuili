...
<script>
import dwd from "@/components/ditu/ditu1.vue";
export default {
  name: "test",
  components: { dwd },
  data() {
  ...
  methods: {
    getData() {
      ...
      this.$Axios
        .get(
          "http://192.168.118.226:9831/webapi/api/v1/service/center/get/data?key=eca70be4-b64e-4653-a084-e271a0d44d7a&guid=f1823477-ffde-4e03-b7e8-a0a83ba35763&type="
        )
        .then(d => {
