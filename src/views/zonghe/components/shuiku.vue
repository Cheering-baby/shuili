...
<template>
    <div style="height:100%;">
        <shuiku :columns="columns" :testData="testData" :chart="chart" :table="table" :form="form" :label="label" :searchContent="search" :lable="label" :iconUrl="iconUrl" />
    </div>
</template>
    ...
    data() {
        return {
           ...
           columns:[
                ...
                { label: "水库名称", field: 'ennm', style: { textAlign: 'center', width: '150px' } },
                { label: "工程规模", field: 'enclnm', style: { textAlign: 'center', width: '40px' } },
           ],
           testData:[],
           chart:{
               width:'600px',
