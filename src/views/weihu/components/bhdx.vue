<template>
  <div class="bhdx" ref="bhdx">
    ...
    <iframe scrolling="no" src="http://192.168.118.226:9831/CommonReport/TableList.aspx?TableDBID=10289&PowerSetStr=Add,Update,Del" frameborder="0" width="100%" :height="height" allowtransparency="true" color="000000"></iframe>
  </div>
</template>
