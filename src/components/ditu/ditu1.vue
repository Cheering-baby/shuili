  ...
  <div class="container1">
    ...
    <el-dialog :title="title" :visible.sync="dialogTableVisible" :modal="false">
      <div class="table_two">
        ...
        <el-row
          style="border-left: 1px solid rgb(235,238,245);border-top:1px solid rgb(235,238,245);"
        >
          <el-col
            :span="12"
...
export default {
  ...
  mounted() {
    this.getData();
    this.tableHeight.height = this.winH - 141 + "px";
  ...
  methods: {
    ...
    searchTable() {
      this.searchContent = this.testData.filter(
        data =>
          !this.search ||
          data.ennm.toLowerCase().includes(this.search.toLowerCase())
      );
    }
  }
};
